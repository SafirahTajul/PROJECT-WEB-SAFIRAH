...
WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/a_Structure'))
...
WebUI.setText(findTestObject('Object Repository/PROJECT WEB/Page_OrangeHRM/input__txtName'), '')
