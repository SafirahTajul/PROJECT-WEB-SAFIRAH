...
WebUI.click(findTestObject('Object Repository/PROJECT WEB/Page_OrangeHRM/a_Structure'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Page_OrangeHRM/input_x_btnEdit'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Page_OrangeHRM/a_'))

WebUI.setText(findTestObject('Object Repository/PROJECT WEB/Page_OrangeHRM/input__txtName'), 'Information Technology')
