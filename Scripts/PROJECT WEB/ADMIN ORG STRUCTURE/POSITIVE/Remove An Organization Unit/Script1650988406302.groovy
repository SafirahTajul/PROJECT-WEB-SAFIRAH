...
WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/a_x'))

WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/input_OrangeHRM - Confirmation Required_dialogYes'))
