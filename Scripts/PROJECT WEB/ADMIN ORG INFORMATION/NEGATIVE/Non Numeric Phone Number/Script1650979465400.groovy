...
WebUI.setText(findTestObject('PROJECT WEB/Page_OrangeHRM/input_Phone_organizationphone'), 'ab123r45')

WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/input__btnSaveGenInfo'))

WebUI.verifyElementText(findTestObject('PROJECT WEB/Page_OrangeHRM/span_Allows numbers and only  -  ( )'), 'Allows numbers and only + - / ( )')
