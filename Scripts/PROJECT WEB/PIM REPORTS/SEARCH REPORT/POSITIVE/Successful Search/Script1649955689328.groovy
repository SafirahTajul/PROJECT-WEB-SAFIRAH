...
WebUI.setText(findTestObject('PROJECT WEB/Page_OrangeHRM/input_Report Name_searchsearch'), 'PIM Sample Report')

WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/input_Report Name__search'))

WebUI.verifyElementText(findTestObject('PROJECT WEB/Page_OrangeHRM/td_PIM Sample Report'), 'PIM Sample Report')
