...
WebUI.setText(findTestObject('PROJECT WEB/Page_OrangeHRM/input_Report Name_searchsearch'), 'Employee Education Details')

WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/input_Report Name__search'))

WebUI.verifyElementText(findTestObject('PROJECT WEB/Page_OrangeHRM/td_No Records Found'), 'No Records Found')
