...
WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/td_Employee Education'))

WebUI.click(findTestObject('PROJECT WEB/Page_OrangeHRM/td_Joined Date Report'))
